...
*/
mis_fichas([[1,2], [3,4], [6,6], [5,3], [2,3], [5,5]]).
mesa([[1,2], [2,4], [4,5]]).
...
asigna_valor_ficha([Num1, Num2 | _], Numero_extremo, Total_mias, Total_jugadas, Valor):-
   Num1 == Num2,
   Num1 == Numero_extremo,
   Valor is 100 * Total_mias * Numero_extremo * Total_jugadas,
   !.

asigna_valor_ficha([Num1 | _], Numero_extremo, Total_mias, Total_jugadas, Valor):-
   Num1 == Numero_extremo,
   Valor is 10 * Total_mias * Numero_extremo * Total_jugadas,
   !.

asigna_valor_ficha([_ | Num2], Numero_extremo, Total_mias, Total_jugadas,  Valor):-
   Num2 == Numero_extremo,
   Valor is 10 * Total_mias * Numero_extremo * Total_jugadas,
   !.
